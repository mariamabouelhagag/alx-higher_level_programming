...
class Rectangle(Base):
    ...
    @property
    def width(self):
        """gettre of the width of the Rectangle."""
        return self.__width
    ...
    @x.setter
    def x(self, value):
        """setter of the x coordinate of the Rectangle."""
        if type(value) != int:
    ...
    @property
    def y(self):
        """getter of the y coordinate of the Rectangle."""
        return self.__y

    @y.setter
    def y(self, value):
        """setter of the y coordinate of the Rectangle."""
        if type(value) != int:
